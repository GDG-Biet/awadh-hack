...
export default function AboutHack() {
  return (
    <Parallax speed={-10}>
      <div
        className="w-11/12 m-auto items-center rounded-2xl"
        id="Handler-css"
      >
        <div className="w-full h-full bg-black bg-opacity-50 flex justify-center items-center md:p-20 p-5">
          <p className="font-semibold md:text-2xl text-xl text-center text-white">
            ...
            {/* It’s a unique opportunity to showcase your skills,
